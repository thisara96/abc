...
#define FIREBASE_HOST "data-6af02.firebaseio.com"
#define FIREBASE_AUTH "rmzvCx64HKRqMLhhrwYGXgD7EfCFIuciqCA6deSy"
...
//  Serial.println(timeStamp);
 ...
 Firebase.push(path1, timeStamp );    // Send Location and time to database 

  path = "Sensor1/" + day + "/" + mincount;
  //  path = "Sensor/" + day + "/" + mincount + "/R";

  Firebase.push(path, lastlocation );
